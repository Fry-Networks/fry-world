  ...
  return (
    <>
      <div className='relative flex'>
        ...
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center px-60 max-sm:px-16 max-sm:text-xs max-sm:pt-32'>
          <h1>Create Your <span className='text-[#00C1F0]'>Algorand-based</span> Token</h1>
  ...
  return (
    <>
      <div className='relative flex'>
        <img className='w-full h-full object-cover' src={bgImg} alt="Hero Image" />
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center px-60 max-sm:px-16 max-sm:text-xs max-sm:pt-32'>
          <h1>Create Your <span className='text-[#00C1F0]'>Solana-SPL</span> Token</h1>
          <div className='flex mt-8 w-2/3 text-center max-sm:hidden'>
  ...
  return (
    <>
      <div className='relative flex'>
        <img className='w-full h-full object-cover' src={bgImg} alt="Hero Image" />
        <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center px-60 max-sm:px-16 max-sm:text-xs max-sm:pt-32'>
          <h1>Create Your <span className='text-[#00C1F0]'>Ethereum ERC20</span> Token</h1>
          <div className='flex mt-8 w-2/3 text-center max-sm:hidden'>
